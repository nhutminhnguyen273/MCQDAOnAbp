...
namespace MCQDAOnAbp.Shared.Hosting.Microservices.DbMigrations.EfCore;

public abstract class PendingEfCoreMigrationsChecker<TDbContext> : PendingMigrationsCheckBase where TDbContext : DbContext
{
