...
namespace MCQDAOnAbp.AdministrationService.DbMigrations;

public class AdministrationServiceDatabaseMigrationChecker : PendingEfCoreMigrationsChecker<AdministrationServiceDbContext>
{
    private readonly IPermissionDefinitionManager _permissionDefinitionManagement;
    private readonly IPermissionDataSeeder _permissionDataSeeder;

    private AdministrationServiceDatabaseMigrationChecker(
        ...
        IPermissionDataSeeder permissionDataSeeder) : base(unitOfWorkManager, serviceProvider, currentTenant, distributedEventBus, abpDistributedLock, AdministrationServiceProperties.ConnectionStringName)
    {
        _permissionDefinitionManagement = permissionDefinitionManager;
    ...
    private async Task SeedDataAsync()
    {
        ...
        var permissionNames = (await _permissionDefinitionManagement.GetPermissionsAsync())
